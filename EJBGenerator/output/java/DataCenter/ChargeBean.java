...
IdleBean Idle;
    ...
    private void triggerTransition() {
        if (blockInputs() && checkExtra()) {
          ...
          String token;
token = Charging.getFirstToken();
Charging.removeToken(token);
Idle.addToken(token);
doExtraStuff();
unblockInputs();
    ...
    private boolean blockInputs() {
        ...
        blocked = blocked && Charging.blockPosition(name);
