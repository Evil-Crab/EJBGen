...
ReturningBean Returning;
    ...
    public void triggerTransition(String key) {
        String token;
token = Reading.getFirstToken(key);
Reading.removeToken(key, token);
Returning.createToken(key);
    ...
    private boolean blockInputs(String key) {
        ...
        blocked = blocked && Reading.blockPosition(key, name);
    ...
    private void unblockInputs(String key) {
        Reading.unblockPosition(key, name);
